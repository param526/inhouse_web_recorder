Feature: User Login Oracle After Fixes
...
Kristin Costine (kcostine@colocrm.com)
Andrew Kern-Goldberger (andy.kern.goldberger@gmail.com)"
And I click on the "Overview
Order #410304
Client: Adina Kern-Goldberger
Order Type: Standard
Ordered By: CryoAdmin Automation
Route
N/A
N/A
Shippers & Commodities
1 shipper, with 0 accessories, containing 0 commodiities, totaling $0.00 USD.
Documentation
Cryoport PO #: N/A
Leg 1 Shipment Reference #: N/A
Notifications
1 contact.
Schedule
Delivery: 24 Nov 2025
Pickup: 25 Nov 2025
Est. Delivery: -
Pickup: -
Review
Order Builder Step 1 of 6 - Route
Origin
Site
...
Select a site or fill out the fields below.

* Company Name
Nickname
* Street Address

Please enter physical street address only

Street Address #2

Please enter Room/Lab/Dept/any other additional information
...
Residential
Contact
Cassie Varrecchione (cassandra.varrecchione@pennmedicine.upenn.edu)
Arsela Gishto (gishtoa@ccf.org)
Kristin Costine (kcostine@colocrm.com)
Andrew Kern-Goldberger (andy.kern.goldberger@gmail.com)
×
...
Destination
Site
FERTILITY LABORATORIES OF COLORADO (CCRM)
×
FERTILITY LABORATORIES OF COLORADO (CCRM)
...
And I click on the "shippers[shippers_attributes][0][commodities_attributes][0][leg_numbers][]"
And I enter "2" into the "shippers[shippers_attributes][0][commodities_attributes][0][leg_numbers][]"
